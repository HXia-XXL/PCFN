...
def Eval():
    ...
    INFER_DIR1 = './prediction/im1/'  # Inference path
    INFER_DIR2 = './prediction/im2/'  # Inference path
    LABEL_DIR1 = './change_detection/val_gt/gt1/'  # GroundTruth path
    LABEL_DIR2 = './change_detection/val_gt/gt2/'  # GroundTruth path
